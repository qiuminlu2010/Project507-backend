...
$ docker run -d --name wordpress --rm -e WORDPRESS_DB_HOST=192.168.198.132:3310 -e WORDPRESS_DB_USER=root -e WORDPRESS_DB_PASSWORD=123456 -p 8081:80 --link mysql_wordpress:mysql wordpress
